...
# Hand-written code should be added in a separate file named Chromatic_AberationExt.py
...
try:
    from Chromatic_AberationExt import *
except ImportError:
    pass

def getPluginID():
    return "Comunity_plug.chromatic_aberation"

def getLabel():
    return "Chromatic_Aberation"

def getVersion():
    return 3

def getIconPath():
    return "Chromatic_Aberation.png"

def getGrouping():
    return "Filter"

def getPluginDescription():
    return "This PyPlug create a chromatic aberation effect, similar to the one found in Blender."
...
def createInstance(app,group):
    ...
    param.setHelp("Strength of the chromatic aberation effect")
    ...
    lastNode.setPagesOrder(['userNatron', 'Node', 'Settings', 'Info', 'Controls'])
    ...
    try:
        extModule = sys.modules["Chromatic_AberationExt"]
    except KeyError:
        extModule = None
